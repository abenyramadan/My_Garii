...
require_once("table/Shipping.php");
...
class API {
    ...
    private function listProductOrder(){
        $this->client->findAllProductOrderPOST();
    }
    private function getProductOrder(){
        $this->client->findProductOrder();
    }
    private function listShipping(){
        $this->client->findAllActiveShipping();
    }
    ...
    private function updateStatusProductOrder(){
        $this->user->checkAuthorization();
        $this->product_order->updateStatusOrder();
    }
    private function deleteOneProductOrder(){
        $this->user->checkAuthorization();
        $this->product_order->deleteOne();
    }
    private function updateOrderPaid(){
        $this->user->checkAuthorization();
        $this->product_order->decreaseStockAndPaid();
    }
    private function refundOrder(){
        $this->user->checkAuthorization();
        $this->product_order->increaseStockAndRefund();
    }
 	...
 	*/
    private function paymentPage(){
        $this->payment->showPage();
    }

    private function getPaymentOrderId(){
        $this->product_order->getPaymentOrderId();
    }

    private function updateProductOrderPayment(){
        $this->product_order->updatePayment();
    }
	...
	/*
	 * TABLE SHIPPING TRANSACTION --------------------------------------------------------------------------------------
	 */
	private function getOneShipping(){
		$this->shipping->findOne();
	}
	private function getAllShippingByPage(){
		$this->shipping->findAllByPage();
	}
	private function getAllShippingCount(){
		$this->shipping->allCount();
	}
	private function insertOneShipping(){
		$this->user->checkAuthorization();
		$this->shipping->insertOne();
	}
	private function updateOneShipping(){
		$this->user->checkAuthorization();
		$this->shipping->updateOne();
	}
	private function deleteOneShipping(){
		$this->user->checkAuthorization();
		$this->shipping->deleteOne();
	}
    private function updateAllShipping(){
        $this->user->checkAuthorization();
	 ...
	 */
    private function getAllConfigByGroup(){
        $this->user->checkAuthorization();
        $this->config->findAllByGroup();
    }

    private function getConfigByCode(){
        $this->user->checkAuthorization();
        $this->config->findByCode();
    }
